...
const INFRA_PRIVACY_RULE =
  "Не упоминай MCP, VNC, CDP, SSH, Docker, compose, chrome, профиль браузера, порты, туннели и внутреннюю инфраструктуру. " +
  "Если источник не ответил — напиши «источник временно недоступен», без инструкций по прогреву и без имён инструментов.";
...
const CHAT_SYSTEM_PROMPT =
  ...
  "и snapshotAvailable=true — это фильтр уже собранной таблицы, не диагностика площадок. " +
