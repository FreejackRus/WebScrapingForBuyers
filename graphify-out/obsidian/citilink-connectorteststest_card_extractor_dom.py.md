...
- [[test_availability_is_read_from_text_content_not_inner_text()]] - `contains` [EXTRACTED]
- [[test_card_extractor_reads_the_product_card()_1]] - `contains` [EXTRACTED]
- [[test_card_prices_are_the_products_own()]] - `contains` [EXTRACTED]
- [[test_credit_and_bonus_amounts_are_not_price_candidates()]] - `contains` [EXTRACTED]
