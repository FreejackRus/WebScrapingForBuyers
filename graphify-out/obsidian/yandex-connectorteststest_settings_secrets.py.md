...
# yandex-connector/tests/test_settings_secrets.py
...
- [[test_the_proxy_secret_is_still_available_to_the_fetch()_4]] - `contains` [EXTRACTED]
- [[test_the_proxy_secret_never_appears_in_settings_dumps()_4]] - `contains` [EXTRACTED]
