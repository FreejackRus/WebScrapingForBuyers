...
## Connections
- [[DetmirCardResponse]] - `imports` [EXTRACTED]
- [[DetmirCategoriesResponse]] - `imports` [EXTRACTED]
- [[DetmirCategory]] - `imports` [EXTRACTED]
- [[DetmirListResponse]] - `imports` [EXTRACTED]
- [[DetmirProduct]] - `imports` [EXTRACTED]
...
- [[_fetch_json()]] - `contains` [EXTRACTED]
- [[_first_brand()]] - `contains` [EXTRACTED]
...
- [[detmir_card()]] - `contains` [EXTRACTED]
- [[detmir_categories()]] - `contains` [EXTRACTED]
- [[detmir_category()]] - `contains` [EXTRACTED]
