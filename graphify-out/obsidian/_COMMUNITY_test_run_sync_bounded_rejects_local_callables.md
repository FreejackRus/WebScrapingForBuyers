...
```dataview
TABLE source_file, type FROM #community/test_run_sync_bounded_rejects_local_callables
SORT file.name ASC
```
...
## Top bridge nodes
- [[test_run_sync_bounded_rejects_local_callables()]] - degree 2, connects to 1 community