...
- [[test_item_no_results_raises_not_found()]] - `calls` [EXTRACTED]
- [[test_item_shape_drift_raises_parser_drift()]] - `calls` [EXTRACTED]
- [[test_validate_skus_rejects_empty()]] - `calls` [EXTRACTED]
- [[test_validate_skus_rejects_non_positive_and_bool()]] - `calls` [EXTRACTED]
- [[test_validate_skus_rejects_too_many()]] - `calls` [EXTRACTED]
