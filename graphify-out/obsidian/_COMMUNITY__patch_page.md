...
- [[test_the_redirect_is_followed()]] - code - mcp-servers/ru-marketplace-mcp/packages/megamarket-connector/tests/test_server.py

## Live Query (requires Dataview plugin)

```dataview
TABLE source_file, type FROM #community/_patch_page
SORT file.name ASC
```

## Connections to other communities
- 4 edges to [[_COMMUNITY_megamarket-connectorteststest_server.py]]

## Top bridge nodes
- [[_patch_page()]] - degree 7, connects to 1 community
- [[test_about_blank_is_not_mistaken_for_a_destination()]] - degree 2, connects to 1 community
- [[test_no_redirect_keeps_the_original_url()]] - degree 2, connects to 1 community
- [[test_the_redirect_is_followed()]] - degree 2, connects to 1 community