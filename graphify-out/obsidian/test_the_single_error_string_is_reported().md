...
# test_the_single_error_string_is_reported()

## Connections
- [[Their failure shape is one `error` string plus a code, not an errors array.]] - `rationale_for` [EXTRACTED]
- [[_patch_graphql_response()]] - `calls` [EXTRACTED]
