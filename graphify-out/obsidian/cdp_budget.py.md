...
## Connections
- [[CDP navigation budget bounded concurrency, per-host serialization, refusals.…]] - `rationale_for` [EXTRACTED]
- [[HostRefusingError]] - `contains` [EXTRACTED]
- [[NavigationBudget]] - `contains` [EXTRACTED]
...
- [[navigation_budget()]] - `contains` [EXTRACTED]
