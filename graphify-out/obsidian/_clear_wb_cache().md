...
- [[test_an_edge_wall_is_not_a_success_and_is_not_cached()]] - `calls` [EXTRACTED]
- [[test_cache_does_not_remember_a_rate_limit()]] - `calls` [EXTRACTED]
- [[test_cache_does_not_remember_a_transient_failure()]] - `calls` [EXTRACTED]
- [[test_cache_serves_a_repeated_successful_read()]] - `calls` [EXTRACTED]
- [[test_gated_hosts_read_through_the_impersonated_transport()]] - `calls` [EXTRACTED]
- [[test_helpers.py]] - `contains` [EXTRACTED]
- [[test_impersonated_body_cap_refuses_an_oversized_payload()]] - `calls` [EXTRACTED]
- [[test_impersonated_refusal_stays_a_transport_error()]] - `calls` [EXTRACTED]
- [[test_impersonated_timeout_uses_the_shared_error_vocabulary()]] - `calls` [EXTRACTED]
