...
# test_parse_retry_after_never_returns_a_non_finite_or_negative_delay()

## Connections
- [[The Retry-After header is wire-authored a hostile or drifted ``1e999`` must…]] - `rationale_for` [EXTRACTED]
