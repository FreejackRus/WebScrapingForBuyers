...
# test_warehouses_shape_drift_raises_parser_drift()

## Connections
- [[_tool_error_payload()_2]] - `calls` [EXTRACTED]
- [[asyncio_1]] - `references` [EXTRACTED]
- [[fake_call()_9]] - `contains` [EXTRACTED]
- [[fake_call()_3]] - `indirect_call` [INFERRED]
