...
- [[test_extractor_surfaces_the_structural_wall_markers()]] - `contains` [EXTRACTED]
- [[test_search_over_the_live_wall_is_transport_down_never_drift()]] - `contains` [EXTRACTED]
- [[test_selfcheck_over_the_live_wall_is_inconclusive_never_drift()]] - `contains` [EXTRACTED]
