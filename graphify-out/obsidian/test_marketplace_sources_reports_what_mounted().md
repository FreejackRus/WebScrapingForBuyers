...
# test_marketplace_sources_reports_what_mounted()

## Connections
- [[A skipped source must be visible to the client, not just to stderr.]] - `rationale_for` [EXTRACTED]
- [[marketplace-connectorteststest_server.py]] - `contains` [EXTRACTED]
