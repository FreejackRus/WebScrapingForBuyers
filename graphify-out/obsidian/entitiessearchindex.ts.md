---
source_file: "apps/web/src/entities/search/index.ts"
type: "code"
...
- [[startindex.ts]] - `imports_from` [EXTRACTED]
- [[suggestindex.ts]] - `imports_from` [EXTRACTED]
- [[useBootSession.ts]] - `imports_from` [EXTRACTED]
- [[useSearchStore]] - `re_exports` [EXTRACTED]
