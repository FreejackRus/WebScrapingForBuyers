...
- [[OzonSearchItemOut]] - `contains` [EXTRACTED]
- [[OzonSearchResponse]] - `contains` [EXTRACTED]
- [[OzonSelfcheckCheckOut]] - `contains` [EXTRACTED]
- [[OzonSelfcheckResponse]] - `contains` [EXTRACTED]
- [[OzonSellerOut]] - `contains` [EXTRACTED]
- [[Pydantic output models for the Ozon MCP connector (Stage 2). Every tool returns…]] - `rationale_for` [EXTRACTED]
