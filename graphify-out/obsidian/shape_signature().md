...
- [[test_a_different_item_count_does_not_register_as_drift()]] - `calls` [EXTRACTED]
- [[test_a_nested_field_disappearing_is_caught()]] - `calls` [EXTRACTED]
- [[test_a_renamed_field_shows_up_as_missing()]] - `calls` [EXTRACTED]
- [[test_a_retyped_field_shows_up_even_when_the_name_survives()]] - `calls` [EXTRACTED]
- [[test_a_scalar_payload_is_handled()]] - `calls` [EXTRACTED]
- [[test_an_emptied_container_is_distinguishable_from_a_populated_one()]] - `calls` [EXTRACTED]
- [[test_bool_is_not_reported_as_int()]] - `calls` [EXTRACTED]
- [[test_card_extractor_shape_matches_golden()]] - `calls` [EXTRACTED]
- [[test_card_normalization_matches_shape_golden()]] - `calls` [EXTRACTED]
- [[test_card_payload_shape_matches_the_capture()_2]] - `calls` [EXTRACTED]
...
- [[test_item_and_warehouse_normalization_match_shape_golden()]] - `calls` [EXTRACTED]
