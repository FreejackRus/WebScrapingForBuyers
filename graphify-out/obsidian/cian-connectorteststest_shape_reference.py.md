...
## Connections
- [[Variant-aware shape goldens for Cian sale, rent and daily offers.]] - `rationale_for` [EXTRACTED]
- [[_signature()]] - `contains` [EXTRACTED]
- [[cian_connector__init__.py]] - `imports_from` [EXTRACTED]
- [[json]] - `imports` [EXTRACTED]
- [[pathlib]] - `imports_from` [EXTRACTED]
- [[resilience.py]] - `imports_from` [EXTRACTED]
- [[test_daily_golden_keeps_explicit_day_unit()]] - `contains` [EXTRACTED]
